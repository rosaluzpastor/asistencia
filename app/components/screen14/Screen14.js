...
export default class Screen14 extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            Component135Visible: true,
            Component134Visible: true,
            Component136Visible: true,
            Component137Visible: true,
        }
                ...
                <View style={styles.screencontainer}>
                    ...
                    <View style={styles.screencontainerInner}>
                        ...
                        <Component135 
                            ...
                            visible={ this.state.Component135Visible }
                        />
                        <Component134 
                            navigation={this.props.navigation}
                            toggleComponent={ (component) => this.toggleComponent(component) }
                            hideComponent={ (component) => this.hideComponent(component) }
                            showComponent={ (component) => this.showComponent(component) }
                            visible={ this.state.Component134Visible }
                        />
                        <Component136 
                            navigation={this.props.navigation}
                            toggleComponent={ (component) => this.toggleComponent(component) }
                            hideComponent={ (component) => this.hideComponent(component) }
                            showComponent={ (component) => this.showComponent(component) }
                            visible={ this.state.Component136Visible }
                        />
                        <Component137 
                            navigation={this.props.navigation}
                            toggleComponent={ (component) => this.toggleComponent(component) }
                            hideComponent={ (component) => this.hideComponent(component) }
                            showComponent={ (component) => this.showComponent(component) }
                            visible={ this.state.Component137Visible }
                        />
